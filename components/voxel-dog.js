...
const VoxelDog = () => {
    ...
    const[initialCameraPostition] = useState(
        new THREE.Vector3(
...
const [scene] = useState(new THREE.Scene())
    const [_constrols,setControls] = useState()
    ...
    useEffect(() => {
        ...
        if (container && !renderer){
            ...
            camera.position.copy(initialCameraPostition)
            ...
            const animate = () => {
             req = requestAnimationFrame(animate)
                ...
                if(frame <= 100) {
                    const p = initialCameraPostition
    ...
    return(
        ...
        >
            ...
            <Spinner
                ...
                top="50%"
                ml="calc(50% - 50px)" 
                mr="calc(0px - var(--spinner-size) / 2)"
