            ...
            <SimpleGrid columns={[1, 1, 2]} gap={10}>
                <Section>
                    <WorkGridItem id="lively" title="Lively" thumbnail={thumbnailLively}>
                        ...
                        this Web application has a Map that provides real-time traffic information depends on your location.
                        also has a 6 kind of article pages that you can just write and view instantly.
                    </WorkGridItem>
                </Section>
            </SimpleGrid>
        </Container>
