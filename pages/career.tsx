    ...
    <Container>
      ...
      <Layout title="career">
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section>
            <CareerGridItem title="KBC2018" thumbnail={thumbnailKbc2018}>
              한국 2018 비트박스 챔피언쉽 주최 참여
            </CareerGridItem>
          </Section>
          <Section>
            <CareerGridItem title="KBC2019" thumbnail={thumbnailKbc2019}>
              한국 2019 비트박스 챔피언쉽 주최 참여
            </CareerGridItem>
          </Section>
          <Section>
            <CareerGridItem title="Mom2019 Vol.1" thumbnail={thumbnailMom2019}>
              M.O.M 비트박스 대회 주최
            </CareerGridItem>
          </Section>
          <Section>
